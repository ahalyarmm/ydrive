...
public class FrontScreen extends AppCompatActivity {
    ...
    public void OnButtonGetToWorkClick(View v) {

        Intent intent = new Intent(FrontScreen.this, GetToWork.class);
        startActivity(intent);
    }

    public void OnButtonGetToAnEventClick(View v) {

        Intent intent = new Intent(FrontScreen.this, GetToAnEvent.class);
        startActivity(intent);
    }
}
